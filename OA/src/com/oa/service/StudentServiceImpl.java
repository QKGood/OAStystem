...
public class StudentServiceImpl implements StudentService{
	...
	@Override
	public long countEmpID(String empId,String stuStatus) {
		return studentDAO.countEmpID(empId,stuStatus);
	}
	...
	public boolean phone(Student stu) {
		return studentDAO.phone(stu);
	}

	@Override
	public void updatePwd(String stuId, String pwd) {
		studentDAO.updatePwd(stuId, pwd);
	}
