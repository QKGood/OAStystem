...
public class DutyDAOImpl extends AbstractBaseDAO<Duty> implements DutyDAO{
	...
	public List<Duty> currDuty(int weekday) {
		...
		for(int i = 0,len = result.size(); i<len; i++) {
			...
			if(obj[10] != null && !obj[10].equals("")&& obj[18] != null && !obj[18].equals("")) { Employee employee = new Employee();employee.setEmpId(obj[10].toString());employee.setName(obj[18].toString()); duty.setEmp1(employee);	}
			if(obj[11] != null && !obj[11].equals("")&& obj[19] != null && !obj[19].equals("")) {Employee employee = new Employee();employee.setEmpId(obj[11].toString());employee.setName(obj[19].toString()); duty.setEmp2(employee);	}
			if(obj[12] != null && !obj[12].equals("")&& obj[20] != null && !obj[20].equals("")) { Employee employee = new Employee();employee.setEmpId(obj[12].toString());employee.setName(obj[20].toString()); duty.setEmp3(employee);	}
			if(obj[13] != null && !obj[13].equals("")&& obj[21] != null && !obj[21].equals("")) { Employee employee = new Employee();employee.setEmpId(obj[13].toString());employee.setName(obj[21].toString()); duty.setEmp4(employee);	}
			if(obj[14] != null && !obj[14].equals("")&& obj[22] != null && !obj[22].equals("")) {Employee employee = new Employee();employee.setEmpId(obj[14].toString());employee.setName(obj[22].toString()); duty.setEmp5(employee);	}
			if(obj[15] != null && !obj[15].equals("")&& obj[23] != null && !obj[23].equals("")) { Employee employee = new Employee();employee.setEmpId(obj[15].toString());employee.setName(obj[23].toString()); duty.setEmp6(employee);	}
			if(obj[16] != null && !obj[16].equals("")&& obj[24] != null && !obj[24].equals("")) { Employee employee = new Employee();employee.setEmpId(obj[16].toString());employee.setName(obj[24].toString()); duty.setEmp7(employee);	}
			if(obj[17] != null && !obj[17].equals("")&& obj[25] != null && !obj[25].equals("")) {Employee employee = new Employee();employee.setEmpId(obj[17].toString());employee.setName(obj[25].toString()); duty.setEmp8(employee);	}
...
//		}
	...
	public void updateDuty(Duty duty) {
		...
		if(duty.getEmp1()!=null){query.setParameter("empid1", duty.getEmp1().getEmpId());}else{query.setParameter("empid1",null);}
		if(duty.getEmp2()!=null){query.setParameter("empid2", duty.getEmp2().getEmpId());}else{query.setParameter("empid2",null);}
		if(duty.getEmp3()!=null){query.setParameter("empid3", duty.getEmp3().getEmpId());}else{query.setParameter("empid3",null);}
		if(duty.getEmp4()!=null){query.setParameter("empid4", duty.getEmp4().getEmpId());}else{query.setParameter("empid4",null);}
		if(duty.getEmp5()!=null){query.setParameter("empid5", duty.getEmp5().getEmpId());}else{query.setParameter("empid5",null);}
		if(duty.getEmp6()!=null){query.setParameter("empid6", duty.getEmp6().getEmpId());}else{query.setParameter("empid6",null);}
		if(duty.getEmp7()!=null){query.setParameter("empid7", duty.getEmp7().getEmpId());}else{query.setParameter("empid7",null);}
		if(duty.getEmp8()!=null){query.setParameter("empid8", duty.getEmp8().getEmpId());}else{query.setParameter("empid8",null);}
	...
	@Override
	public void addAddress(String addressCol, String address,String empCol,String empid) {//添加某个值班地点
		Session session= getSessionFactory().getCurrentSession();
		String sql = "update t_duty set "+ addressCol + "=:addName , " +empCol +"=:empid";
		SQLQuery query = session.createSQLQuery(sql);
		
		query.setParameter("addName", address);
	...
	@Override
	public int countTab() {
		String sql = " select count(*) from t_duty ";
		Session session = getSessionFactory().getCurrentSession();
		SQLQuery query = session.createSQLQuery(sql);
