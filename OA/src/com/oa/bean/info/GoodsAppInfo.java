...
public class GoodsAppInfo {
	...
	public String toString() {
		return "GoodsAppInfo [goodsAppId=" + goodsAppId + ", empId=" + empId + ", empName=" + empName + ", appDay="
				+ appDay + ", goodsName=" + goodsName + ", quantity=" + quantity + ", des=" + des + ", status=" + status
				+ ", appStatus=" + appStatus + ", price=" + price + ", getGoodsAppId()=" + getGoodsAppId()
				+ ", getEmpId()=" + getEmpId() + ", getEmpName()=" + getEmpName() + ", getAppDay()=" + getAppDay()
				+ ", getGoodsName()=" + getGoodsName() + ", getQuantity()=" + getQuantity() + ", getDes()=" + getDes()
				+ ", getStatus()=" + getStatus() + ", getAppStatus()=" + getAppStatus() + ", getPrice()=" + getPrice()
