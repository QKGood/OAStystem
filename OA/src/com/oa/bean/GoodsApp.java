...
public class GoodsApp {
	...
	private String goodsName; 	// 用品名称 	XMF	
	...
	public String toString() {
		return "GoodsApp [goodsAppId=" + goodsAppId + ", emp=" + emp + ", empId=" + empId + ", appDay=" + appDay
				+ ", goodsName=" + goodsName + ", quantity=" + quantity + ", des=" + des + ", status=" + status
				+ ", appStatus=" + appStatus + "]";
	}
