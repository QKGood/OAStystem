	...
	<div class="lg" >
		...
		<div class="col-md-12">
			...
			<form
				...
				role="form" action="<%=path %>/login/student" method="post">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="username" name= "student.phone"placeholder="请学生输入用户名">
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-12">
						<div class="control-wrapper">
							<label for="password" class="control-label fa-label"><i
								...
								class="form-control" id="password" name="student.pwd"placeholder="请学生输入密码">
						</div>
					</div>
				</div>
