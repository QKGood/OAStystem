...
<script>
	...
	<%-- function getLaterCount() {
		$.get("<%=path%>/empChecking/pager", function(data){
			var laterCount = data.rows[0].laterCount;
			$("#lc").textbox('setValue', laterCount);
		},"json");
	} --%>
	...
	<table id="list" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'salaryday',width:200" formatter="formatterDate">发放时间</th>
	...
	<div id="addWin" class="easyui-window" title="添加" data-options="closed:true" style="width:366px;height:300px;">
		<form id="addForm">
			...
			<!-- 	<tr>
				...
				<tr>
					<td>奖励</td>
					<td><input class="easyui-validatebox easyui-numberbox" id="sb" name="salary.extrasalary" data-options="required:true,validType:'length[3,5]'"/></td>
				</tr>
	...
	<div id="editWin" class="easyui-window" title="编辑" data-options="closed:true" style="width:335px;height:260px;">
		<form id="editForm">
			...
			<table>
				<tr>
					<td>奖励</td>
					<td><input class="easyui-validatebox easyui-numberbox" name="salary.extrasalary" data-options="required:true,validType:'length[3,5]'"/></td>
				</tr>
				<tr>
					<td>发放时间</td>
					<td>
