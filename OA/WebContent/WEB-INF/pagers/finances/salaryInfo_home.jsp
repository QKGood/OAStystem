...
<script>
	...
	function showAddEmpSalaryWin() {
		authority('com.oa.action.SalaryInfoAction.addSalary', "", "add",'');
		/* $("#addWin").window("open");
	...
	function showEditEmpSalaryWin() {
		...
		if (rows.length > 1) {
			...
			if (row) {
				...
				authority('com.oa.action.SalaryInfoAction.updataSalary', jsonStr1, "edit",'');
			}
...
<body style="width:100%; margin:0px;">
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			...
			<input class="easyui-searchbox" data-options="prompt:'查询员工',menu:'#mm', searcher:doSearch" style="width:300px" id="isED"></input>
		</div>
	</div>
	...
	<div id="addWin" class="easyui-window" title="添加" data-options="closed:true" style="width:380px;height:280;">
		<form id="addForm">
			...
			<table>
				...
				<tr>
					<td>员工姓名</td>
					<td><input class="easyui-validatebox easyui-textbox" id = "empName"   name="salaryInfo.emp.name"  data-options="required:true" disabled="disabled"/></td>
					<td><a href="javascript:;" onclick = "selectDept()" >选择</a></td>
				</tr>
				<tr>
					<td>基本工资</td>
					<td><input class="easyui-validatebox easyui-numberbox" name="salaryInfo.basicSalary" data-options="required:true,validType:'length[4,5]'"/></td>
				</tr>
				<tr>
					<td>岗位工资</td>
					<td><input class="easyui-validatebox easyui-numberbox" name="salaryInfo.jobSalary" data-options="required:true,validType:'length[4,5]'"/></td>
				</tr>
				<tr>
					<td>
