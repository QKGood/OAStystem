...
<table id="list" class="easyui-datagrid"
		...
		<thead>
			...
			<th data-options="field:'feedbackId',checkbox:true">反馈编号</th>
				...
				<th data-options="field:'feedbackDay',width:140,align:'center'" formatter="formatterDate">反馈时间</th>
	...
	<div id="addWin" class="easyui-window" title="添加我的反馈" data-options="closed:true" style="width:350px;height:300px;">
		<form id="addForm">
			<table>
				<tr>
	...
	<div id="editWin" class="easyui-window" title="修改反馈" data-options="closed:true" style="width:350px;height:300px;">
		<form id="editForm">
