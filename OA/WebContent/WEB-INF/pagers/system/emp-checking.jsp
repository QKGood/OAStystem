...
<script>
	...
	function showEditCheckingWin() {
		...
		if (rows.length > 1) {
			$.messager.alert("提示", "请先选择一个需要修改的行", "info");
...
<table id="list" class="easyui-datagrid"
	...
	<div id="addWin" class="easyui-window" title="添加打卡时间" data-options="closed:true" style="width:300px;height:300px;">
		<form id="addForm">
			<table>
				<tr>
					<td>打卡描述</td>
	...
	<div id="editWin" class="easyui-window" title="修改公告类型" data-options="closed:true" style="width:300px;height:300px;">
		<form id="editForm">
