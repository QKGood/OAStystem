...
<script type="text/javascript">
	...
	var jsonStr = '{"goods.goodsId":"_goodsId","goods.name":"_name","goods.quantity":"_quantity"'
		...
		+ ',"goods.goodsTypeId.goodsTypeId":"_goodsTypeId","goods.goodsTypeName.name":"_goodsTypeName"}';
		...
		if (rows.length > 1) {
			...
			if (row) { // 有选中的行
				var jsonStr1 = jsonStr.replace("_goodsId", row.goodsId).replace("_name",row.name).
					...
					replace("_goodsTypeId",row.goodsTypeId).replace("_goodsTypeName",row.goodsTypeId.name).
...
<body style="height:100%;">
	...
	<table id="list" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'buyDay',align:'center',width:150" formatter="formatterDate">购买时间</th>
	...
	<div id="addWin" class="easyui-window" title="添加物品" data-options="closed:true" style="width:300px;height:280px;">
		<form id="addForm">
			<table>
				...
				<tr>
					<td>物品总数</td>
					<td><input class="easyui-numberbox" name="goods.quantity" data-options="required:true,min:1"/></td>
				</tr>
				<tr>
					<td>物品描述</td>
	...
	<div id="editWin" class="easyui-window" title="更新物品" data-options="closed:true" style="width:300px;height:280px;">
		<form id="editForm">
			...
			<input type="hidden"  name="goods.buyDay"  /> 
			<table>
				<tr>
					<td>物品名称</td>
					<td><input class="easyui-validatebox easyui-textbox" name="goods.name" data-options="required:true,validType:'length[2,20]'"/></td>
				...
				<tr>
					<td>物品总数</td>
					<td><input class="easyui-validatebox easyui-numberbox" name="goods.quantity" data-options="required:true,min:1"/></td> 
				</tr>
				<tr>
					<td>物品描述</td>
					<td><input class="easyui-textbox" name="goods.des" data-options="required:true,validType:'length[2,20]'"/></td>
				...
				<tr>
					<td>物品类型</td>
					<td>
						<input class="easyui-combobox" id="goodsType" name="goods.goodsTypeId.goodsTypeId"
